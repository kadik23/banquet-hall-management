  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (isEditMode) {
        ...
        window.alert(`Le client ${data.clientId} a été modifié avec succès`);
        ...
        window.alert(`Le client ${data.clientId} a été créé avec succès`);
      ...
      window.alert("Une erreur s'est produite lors du traitement de la demande.");
